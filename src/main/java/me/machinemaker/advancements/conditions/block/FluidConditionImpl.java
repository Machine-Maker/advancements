...
record FluidConditionImpl(
    ...
    static final ConditionType<FluidCondition> TYPE = ConditionType.create(FluidCondition.class, ANY, FluidCondition::requiredGson);
    static final TypeAdapterFactory FACTORY = ConditionAdapterFactory.record(TYPE, FluidConditionImpl.class);
    public static final GsonBuilderApplicable REQUIRED_GSON = Builders.collection(Adapters.FLUID_TAG_ADAPTER, Adapters.FLUID_ADAPTER, BlockPropertyCondition.requiredGson(), Builders.factory(FACTORY));
