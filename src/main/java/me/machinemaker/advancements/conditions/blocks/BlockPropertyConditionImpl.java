...
record BlockPropertyConditionImpl(List<BlockPropertyCondition.Matcher> properties) implements BlockPropertyCondition {
    ...
    static final GsonBuilderApplicable REQUIRED_GSON = Builders.typeHierarchy(BlockPropertyCondition.class, new Adapter());
    static final ConditionType<BlockPropertyCondition> TYPE = ConditionType.create(BlockPropertyCondition.class, ANY, BlockCondition::requiredGson);
