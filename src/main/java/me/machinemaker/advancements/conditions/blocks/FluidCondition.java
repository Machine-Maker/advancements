...
public interface FluidCondition extends Condition<FluidCondition>, Buildable<FluidCondition, FluidCondition.Builder> {
    ...
    static GsonBuilderApplicable requiredGson() {
        return FluidConditionImpl.REQUIRED_GSON;
    }
