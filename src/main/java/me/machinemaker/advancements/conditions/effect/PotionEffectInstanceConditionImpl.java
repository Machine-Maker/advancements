...
record PotionEffectInstanceConditionImpl(
    ...
    static final ConditionType<PotionEffectInstanceCondition> TYPE = ConditionType.create(PotionEffectInstanceCondition.class, ANY, PotionEffectInstanceCondition::requiredGson, false);
    static final TypeAdapterFactory FACTORY = ConditionAdapterFactory.record(TYPE, PotionEffectInstanceConditionImpl.class);
    static final GsonBuilderApplicable REQUIRED_GSON = Builders.collection(IntegerRange.requiredGson(), Builders.factory(FACTORY));
