...
final class EntityConditionImpl implements EntityCondition {
    ...
    static final EntityCondition ANY = new EntityConditionImpl(EntityTypeCondition.conditionType().any(), DistanceCondition.conditionType().any(), LocationCondition.conditionType().any(), LocationCondition.conditionType().any(), PotionEffectsCondition.conditionType().any(), NBTCondition.conditionType().any(), EntityFlagsCondition.conditionType().any(), EntityEquipmentCondition.conditionType().any(), /*EntitySubCondition.ANY*/ null);
    static final ConditionType<EntityCondition> TYPE = ConditionType.create(EntityCondition.class, ANY, EntityCondition::requiredGson);
    static final TypeAdapterFactory FACTORY = ConditionAdapterFactory.type(TYPE, EntityConditionImpl.class);
    static final GsonBuilderApplicable REQUIRED_GSON = Builders.collection(
        EntityTypeCondition.requiredGson(),
        DistanceCondition.requiredGson(),
        LocationCondition.requiredGson(),
        PotionEffectsCondition.requiredGson(),
        NBTCondition.requiredGson(),
        EntityFlagsCondition.requiredGson(),
        EntityEquipmentCondition.requiredGson(),
    ...
    // private final EntitySubCondition typeSpecific; TODO
    ...
    private EntityConditionImpl(final EntityTypeCondition type, final DistanceCondition distance, final LocationCondition location, final LocationCondition steppingOn, final PotionEffectsCondition effects, final NBTCondition nbt, final EntityFlagsCondition flags, final EntityEquipmentCondition equipment, final EntityCondition vehicle, final EntityCondition passenger, final EntityCondition targetedEntity, final @Nullable String team) {
        this.type = type;
    ...
    private EntityConditionImpl(final EntityTypeCondition type, final DistanceCondition distance, final LocationCondition location, final LocationCondition steppingOn, final PotionEffectsCondition effects, final NBTCondition nbt, final EntityFlagsCondition flags, final EntityEquipmentCondition equipment, final @Nullable String team) {
        this.type = type;
        this.distance = distance;
        this.location = location;
        this.steppingOn = steppingOn;
