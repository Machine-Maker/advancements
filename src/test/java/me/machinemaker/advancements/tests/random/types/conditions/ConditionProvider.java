package me.machinemaker.advancements.tests.random.types.conditions;
...
public abstract class ConditionProvider<C extends Condition<C>, B extends Condition.Builder<C>> implements Provider<C> {
    ...
    private List<Component<B>> random() {
        ...
        return new ArrayList<>(this.conditions.get().subList(1, ThreadLocalRandom.current().nextInt(2, this.conditions.get().size() + 1)));
    }
